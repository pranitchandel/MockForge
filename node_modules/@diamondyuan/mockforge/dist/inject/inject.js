...
var require_dist = __commonJS({
  "node_modules/.pnpm/path-to-regexp@8.0.0/node_modules/path-to-regexp/dist/index.js"(exports2) {
    ...
    function compile(path, options = {}) {
      return $compile(path instanceof TokenData ? path : parse2(path, options), options);
    }
    ...
    function match2(path, options = {}) {
      ...
      const items = paths.map((path2) => path2 instanceof TokenData ? path2 : parse2(path2, options));
...
var BrowserMockForgeEventListener = class {
  baseUrl;
  clientId;
  ws = null;
...
// src/ui/service/service.ts
var BrowserMockForgeStateService = class {
  baseURL;
  clientId;
  constructor(baseURL, clientId) {
    this.baseURL = baseURL;
...
function getInitialStateSync(baseUrl, clientId) {
  const xhr = new XMLHttpRequest();
  xhr.open("POST", `${baseUrl}/api/v1/mockforge/rpc`, false);
...
var RequestSimulator = class {
  ...
  getActiveAPIs = () => {
    return this.apiCollection.map((o) => {
      ...
      return {
        ...o,
        mockResponses: o.mockResponses.filter(
          (o2) => activeAPI.activeMockResponses.includes(o2.name)
        )
      };
    }).filter((o) => o !== null);
  };
  ...
  _handleSimulatedRequest(request) {
    ...
    if (typeof request.body !== "string" && request.body !== void 0 && request.body !== null) {
      return null;
    }
