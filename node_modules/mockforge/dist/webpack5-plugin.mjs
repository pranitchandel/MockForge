...
var MockForgeSDK = class {
  ...
  resolveHttpApiDir(method, pathname) {
    ...
    return path.join(this.baseDir, "http", dirname2);
  }
...
var MockForgeWebpackPlugin = class {
  ...
  apply(compiler) {
    ...
    const finalBaseDir = mockDataDir || path2.join(process.cwd(), ".mockforge");
    ...
    compiler.hooks.afterEnvironment.tap("MockForgeWebpackPlugin", async () => {
      if (this.isMockEnabled) {
        const result = await createMockForgeServer({
          ...
          static: [path2.join(getDirname(), "ui"), path2.join(getDirname(), "inject")],
    ...
    compiler.hooks.compilation.tap("MockForgeWebpackPlugin", (compilation) => {
      ...
      if (HtmlWebpackPlugin && typeof HtmlWebpackPlugin.getHooks === "function" && HtmlWebpackPlugin.getHooks(compilation) && HtmlWebpackPlugin.getHooks(compilation).beforeEmit) {
...
vary/index.js:
   ...
   *)
*/
//# sourceMappingURL=webpack5-plugin.mjs.map
