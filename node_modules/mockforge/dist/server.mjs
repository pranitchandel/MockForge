...
var require_json_stable_stringify = __commonJS({
  "node_modules/.pnpm/json-stable-stringify@1.1.1/node_modules/json-stable-stringify/index.js"(exports, module) {
    ...
    module.exports = function stableStringify2(obj) {
...
// src/server/node/nodeMockForgeService.ts
...
// src/server/node/nodeMockForgeService.ts
var NodeMockForgeService = class extends BaseMockForgeService {
  getWebsocket(url) {
...
var serverDebugLog = create("mockforge:server");
var vitePluginDebugLog = create("mockforge:vite-plugin");
